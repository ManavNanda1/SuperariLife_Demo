...
namespace SuperariLife.Common.EmailNotification
{
    /// <summary>
    ...
    public class EmailNotification
    {
        ...
        public static bool SendMailMessage(string recipient, string bcc, string cc, string subject, string body, EmailSetting emailSetting, string attachment)
        {
            ...
            {
                new EmailImages() { ImageName = "superarilife-logo.png", ContentId = "companylogo" }
            };
            ...
            {
                string BasePathImages = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "EmailTemplates", "images");
